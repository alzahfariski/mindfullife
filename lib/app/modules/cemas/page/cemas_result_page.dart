...
class CemasResultPage extends StatelessWidget {
  const CemasResultPage({super.key});
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CircularPercentIndicator(
                        ...
                        progressColor: dassCemasController.colorStattus.value,
                        radius: 60,
                      ),
                    ),
                    const SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          LinearPercentIndicator(
                            ...
                            percent: dassCemasController.precent.value,
                            trailing: Text(
                              '${dassCemasController.precent.value * 100} %',
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyMedium!
                                  .copyWith(fontWeight: FontWeight.w600),
