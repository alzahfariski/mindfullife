...
class DepreesiResultPage extends StatelessWidget {
  const DepreesiResultPage({super.key});
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CircularPercentIndicator(
                        ...
                        progressColor: dassDepresiController.colorStattus.value,
                        radius: 60,
                      ),
                    ),
                    const SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          LinearPercentIndicator(
                            ...
                            percent: dassDepresiController.precent.value,
                            trailing: Text(
                              '${dassDepresiController.precent.value * 100} %',
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyMedium!
                                  .copyWith(fontWeight: FontWeight.w600),
